...
public class TilematchStorage {
	static public class ScoreOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String SCORE_TABLE_CREATE = "create table score(rowid integer primary key autoincrement , name char2(25) default 'Anonymous', mode number(1) default '0', difficulty number(1) default '1', points number(7) default '0', time number(5) default '0', level number(3) default '1')";
